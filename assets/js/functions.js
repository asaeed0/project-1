...
function updateCityData(d) {
    ...
    // High
    cityData.high = d.forecastDays5.DailyForecasts["0"].Temperature.Maximum.Value;
    // Low
...
function updateCityHtml() {
    $("#cityData-name").text(cityData.name);
    $("#cityData-high").text(cityData.high);
    $("#cityData-low").text(cityData.low);
    $("#cityData-realfeel").text(cityData.currentConditions.realFeel);
    $("#cityData-description").text(cityData.currentConditions.description);
    $("#cityData-temperature").text(cityData.currentConditions.temperature);
    $("#cityData-humidity").text(cityData.currentConditions.humidity);
    $("#cityData-windspeed").text(cityData.currentConditions.windspeed);
}